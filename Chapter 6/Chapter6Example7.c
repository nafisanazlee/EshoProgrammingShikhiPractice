/*
A program to make the final result of a class.
*/
#include <stdio.h> 
int main() 
{ 
...
final_marks[i] / 2.0; 
 ...
 /*
 1st Student's (whose roll is 1) number is in total_marks[0](in index 0,as the first element is there.
 therefore roll n's number is in total_marks[n-1]
 */
 } 
 return 0; 
} 